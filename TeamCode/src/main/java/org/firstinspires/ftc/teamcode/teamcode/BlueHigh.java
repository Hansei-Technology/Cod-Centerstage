...
public class BlueHigh extends LinearOpMode {
    ...
    public static Pose2d LEFT = new Pose2d(17.5, 9, Math.toRadians(0));
    public static Pose2d RIGHT = new Pose2d(30, -5, Math.toRadians(270));
    public static Pose2d MID = new Pose2d(25.6, 3, Math.toRadians(0));
    public static Pose2d BACKBOARD = new Pose2d(26, 28, Math.toRadians(270));
    public static Pose2d BACKBOARD_LEFT = new Pose2d(20, 29.5, Math.toRadians(270));
