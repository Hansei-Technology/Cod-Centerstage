...
public class BlueLow extends LinearOpMode {
    ...
    public static Pose2d EOOK = new Pose2d(21, 0.5, Math.toRadians(0));
    public static Pose2d EOOK2 = new Pose2d(1.5, 4.2, Math.toRadians(270));
    public static Pose2d LEFT = new Pose2d(19.3, 3, Math.toRadians(90));
    public static Pose2d RIGHT = new Pose2d(16.1, -6, Math.toRadians(0));
    public static Pose2d MID = new Pose2d(25.7, 0.3, Math.toRadians(0));
    public static Pose2d BACKBOARD = new Pose2d(26, 28, Math.toRadians(270));
    public static Pose2d BACKBOARD_LEFT = new Pose2d(1.5, 82.3, Math.toRadians(270));
    public static Pose2d BACKBOARD_RIGHT = new Pose2d(30, 29.5, Math.toRadians(270));
    public static Pose2d PARK = new Pose2d(50, 29.5, Math.toRadians(270));
        ...
        switch (result) {
            ...
            case LEFT: {
                mainTrajectoryBuilder
                        ...
                        .addSpatialMarker(EOOK.vec(), () -> {
                            jointController.endAuto();
                        });
//                        .lineToLinearHeading(EOOK2)
//                        .lineToLinearHeading(BACKBOARD_LEFT);
//                        .addSpatialMarker(BACKBOARD_RIGHT.vec(), () -> {
